...
<p>
  Para cualquier conflicto que pueda derivarse del uso del sitio web, y siempre que la normativa aplicable no establezca lo contrario,
  las partes se someterán a los juzgados y tribunales competentes del domicilio del titular del negocio.
</p>
      `,
    },
    en: {
